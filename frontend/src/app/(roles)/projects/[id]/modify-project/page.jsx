        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-1 gap-4">
            <div>
              ...
              <input
                ...
                required
                className="w-full bg-white border border-black rounded-md p-3 focus:outline-none focus:ring-2 focus:ring-gray-300"
              />
            </div>
            <div>
              <label className="block text-sm font-medium mb-1">
            ...
            <div>
              ...
              <div className="relative">
                <select
                  ...
                  onChange={handleChange}
                  required
                  className="appearance-none w-full bg-[#F4F4F4] text-black py-3 px-4 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-300"
                >
          ...
          <label className="inline-flex items-center mb-4">
            <input
              ...
              onChange={handleChange}
              className="appearance-none w-5 h-5 border border-black rounded-sm checked:bg-black checked:border-black focus:outline-none focus:ring-2 focus:ring-gray-300"
            />
          ...
          <div className="flex justify-between mt-6">
            ...
            >
              <FaCheckCircle className="text-white" /> Guardar Proyecto
            </button>
          </div>
        </form>
      </div>
