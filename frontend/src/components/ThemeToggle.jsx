...
export default function ThemeToggle({ initialTheme }) {
  // El layout nos pasa initialTheme = "dark" o "light"
  ...
  const handleToggle = () => {
    ...
    startTransition(async () => {
      // 1) Guardamos la cookie en el server
      await setThemeCookie(newTheme);
      // 2) Refrescamos para forzar que el layout
      //    se renderice de nuevo en el servidor
      router.refresh();
    });
  };
