...
const CarruselProyectos = () => {
  ...
  return (
    <div className="w-full max-w-7xl mx-auto p-4">
      ...
      <h2 className="text-2xl bg-card font-bold text-left mb-6 inline-block px-4 py-2">
      ...
      <div className="overflow-x-auto flex gap-4 p-2 scrollbar-hide">
        {proyectos.map((proyecto, index) => (
          <div
            key={index}
            className="bg-card h-48 w-64 flex items-center justify-center text-gray-500 shadow-md min-w-[250px] relative"
          >
