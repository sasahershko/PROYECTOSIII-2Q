...
export default function ModifyProjectForm({ project }) {
    ...
    return (
        <div className="bg-gradient-to-b from-primary-bg to-card min-h-screen">
          <div className="text-5xl text-center py-8 font-bold text-primary-text bg-card shadow-sm">
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-accent to-secundary-text">
