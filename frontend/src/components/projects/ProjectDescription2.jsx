    ...
    return (
        <div className="h-screen grid grid-cols-3 grid-rows-2 mb-10">
            ...
            <div className="col-span-2 row-span-2">
                ...
                <div className='mt-8 ml-6 h-[400px] w-full border space-y-6 shadow-lg rounded-xl text-primary-text'>
                    <div className='flex justify-between'>
                        <div className='flex gap-2 mt-6 ml-4'>
                            {NotesIcon}
                            <h1 className='text-xl font-semibold -mt-1'>Notas</h1>
                        </div>
                    ...
                    <div className='flex justify-center items-center h-[calc(100%-80px)]'>
                        <div className='bg-gray-100 w-[95%] h-[90%] rounded-xl shadow-inner' >
                            {notas.length > 0 ?
                                notas.map((nota, index) => (
                                    <div key={index} className='flex justify-center items-center '>
                                        <div className='mt-2 bg-white w-[1070px] h-[100px] rounded-lg'>
                                            <p>{nota.note}</p>
                                        </div>
                                    </div>
