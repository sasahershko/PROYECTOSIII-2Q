...
export default function ProjectUserSelector({ availableUsers = [], selectedUsers, setSelectedUsers, label }) {
    ...
    return (
        <div className="mb-4 relative">
            ...
            {/* Selected users with improved cards */}
            <div className="mt-5">
                ...
                {selectedUsers.length === 0 && (
                    <div className="border border-dashed border-secundary-text/30 rounded-lg p-6 text-center text-secundary-text">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            className="h-10 w-10 mx-auto mb-2 text-secundary-text/50"
                            fill="none"
                            viewBox="0 0 24 24"
                            stroke="currentColor"
                        >
                        ...
                        <p>Busca y selecciona usuarios para añadirlos al proyecto</p>
                    </div>
                )}
            </div>
        </div>
