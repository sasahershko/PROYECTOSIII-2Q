...
import {
    CalendarIcon, User, Users, UserCog
} from "lucide-react"
            ...
            <CardContent className="p-0 bg-primary-bg">
                <Tabs defaultValue="team" className="w-full">
                    <TabsList className="grid grid-cols-2 w-full rounded-t-lg rounded-b-none">
                        <TabsTrigger value="team"><Users className="w-4 h-4" /> Equipo</TabsTrigger>
                        <TabsTrigger value="details"><UserCog className="w-4 h-4" /> Detalles</TabsTrigger>
                    </TabsList>
                                        ...
                                        <TooltipProvider key={i}>
                                            <Tooltip>
                                                <TooltipTrigger asChild>
                                                    <div className="flex items-center gap-3 p-2 rounded-md hover:bg-primary-bg dark:hover:bg-gray-800">
                                                        <Avatar>
                                                ...
                                                <TooltipContent><p>{user.email}</p></TooltipContent>
                                            </Tooltip>
                                        </TooltipProvider>
                                    ))}
                                </ScrollArea>
                                    ...
                                    {project.responsibles.map((person, i) => (
                                        <TooltipProvider key={i}>
                                            <Tooltip>
                                                ...
                                                <TooltipContent><p>{person.email}</p></TooltipContent>
                                            </Tooltip>
                                        </TooltipProvider>
                                    ))}
                                </div>
